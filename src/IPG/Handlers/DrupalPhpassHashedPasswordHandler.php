...
use IPG\Utility\DrupalCrypt;
use IPG\Interfaces\DrupalPasswordInterface;

class DrupalPhpassHashedPasswordHandler implements DrupalPasswordInterface {
    ...
    protected function generateSalt() {
      ...
      $output .= $this
        ->base64Encode(DrupalCrypt::randomBytes(6), 6);
      return $output;
    }
    ...
    protected function crypt($algo, $password, $setting) {
      ...
      if (strlen($password) > DrupalPasswordInterface::PASSWORD_MAX_LENGTH) {
        return FALSE;
      }
    ...
    public function check($password, $hash) {
      ...
      return $computed_hash && DrupalCrypt::hashEquals($stored_hash, $computed_hash);
    }
